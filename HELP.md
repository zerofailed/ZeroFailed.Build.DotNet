...
| `UseGitHubFlavour`                         | $IsGitHubActions          | ZF_BUILD_DOTNET_USE_GITHUB_FLAVOUR               | When true, the Markdown code coverage summary is generated in the GitHub-optimised format ('SummaryGithub.md'), which is the file the shared 'Add Code Coverage PR comment' action looks for. Defaults to true when running on GitHub Actions. |
