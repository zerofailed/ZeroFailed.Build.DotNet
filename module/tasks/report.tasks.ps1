...
task TruncateOversizedCoverageReport -If {$TruncateOversizedCoverageReport -and $GenerateMarkdownCodeCoverageSummary} PrepareTestReportParameters,{
    ...
    # The summary is generated by the 'GenerateMarkdownCodeCoverageSummary' task earlier in this
    # same 'TestReport' build, so it exists at this point.
